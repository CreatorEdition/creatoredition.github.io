const locations = {
  "广东省" : {
    title: "粤康码",
    link: "ykm",
    help_text: '<p>由“广东大数据中心”提供，含以下功能：</p> <ul> <li><i>健康状态查询</i> <p>查询自身健康状态，作为复工复产、日常出行防疫相关健康状态参考</p> </li> </ul>'
  },
  "江苏省" : {
    title: "苏康码",
    link: "skm",
  ...
  "天津市" : {
    title: "津心办天津健康码",
    link: "tianjin-hc",
    help_text: '<p>根据”天津市疫情防控工作指挥部“通告，在以下场所可用：</p> <ul> <li><i>交通出行</i><p>机场、火车站、公交地铁乘车等</p></li> <li><i>公共场所</i><p>小区，大型超时，商场，市场等</p> </li> </ul>'
  },
  "陕西省" : {
    title: "陕西一码通",
    link: "shaanxi-hc",
    help_text: '<p>由”陕西省政务服务大数据“提供，使用场景：</p> <ul> <li><i>查询及申报</i><p>个人健康信息、行程信息、疫苗接种信息、核酸结果信息查询；健康情况、行程情况申报</p></li> <li><i>代查及代领</i><p>代他人领、查，亲友代领等相关功能</p></li> <li><i>其他功能</i><p>场所码申领、场所码扫码、风险地区查询等。</p> <li><i>温馨提示</i><p>省内以及跨省通行，公共场所出入等具体适用场景以当地政府部门规定为准</p> </li> </ul>'
  },
  "重庆市" : {
    title: "渝康码",
    link: "chongqing-hc",
